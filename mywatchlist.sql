...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2020 at 12:25 PM
...
INSERT INTO `accs` (`id`, `Username`, `Password`) VALUES
(1, 'Me', '123');
...
CREATE TABLE `planning` (
  `Planning to Watch` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `watching` (`Watching`) VALUES
('Baywatch');
